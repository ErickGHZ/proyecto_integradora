...
<html>
<head>
    <link rel="stylesheet" type="text/css" href="styles_eliminar_grupos.css">
...
<div id="contenedor2">
    ...
    <div id="tabla-contenedor" class="tabla-contenedor">
        <form action="drop_grupos.php" method="post" onsubmit="return confirm('¿Estás seguro de eliminar este grupo? Todos los datos relacionados con este grupo se eliminaran');">
            <table>
                <tr>
                    <th>Id grupos</th>
